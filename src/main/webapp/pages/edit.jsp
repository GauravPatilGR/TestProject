...
<form action="sham" method="post"  enctype="multipart/form-data">
  
  <h1><strong>Register Details Edit Form</strong>Edit Profile</h1>
  
   <input type="hidden" name="id" value="${k.id}" class="form-controll"/>
  
  <div class="form-group">
    <label for="title">Enter Full Name</label>
    <input type="text" name="name" value="${k.name}" class="form-controll"/>
  </div>
  <div class="form-group">
    <label for="caption">Enter Email</label>
    <input type="text" name="email" value="${k.email}" class="form-controll"/>
  </div>
